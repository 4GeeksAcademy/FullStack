...
def crear_servicios_belleza(user_id, belleza_category_id):
    if not Belleza.query.filter_by(category_id=belleza_category_id).first():
        belleza_services = [
            Belleza(
                title="Paquete Gold",
                descripcion="Paquete Oro Ideal para bodas íntimas de hasta 50 invitados, nuestro Paquete Oro incluye: Ceremonia Civil y Religiosa Coordinamos tanto la boda civil como la ceremonia religiosa en iglesia, gestionando permisos y decoración. Selección de Finca Exclusiva Te ayudamos a escoger la finca perfecta —rústica o moderna— según tu estilo y presupuesto. Catering Premium (Menú de 3 Platos) – Entrante · Plato principal · Postre – Servicio de camareros y puesta de mesas incluidos",
                image="https://res.cloudinary.com/dlcovtv8q/image/upload/v1748587516/adb01833-8d25-4355-8b8e-d685226e697d_krasw6.png",
                city="España",
                price=26000,
                discountPrice=22825,
                rating=4.8,
            ...
            Belleza(
                ...
                descripcion="Ideal para bodas de hasta 100 invitados, nuestro Paquete Platino incluye la coordinación de la ceremonia civil y religiosa (permisos y decoración), la selección de una finca exclusiva —rústica o moderna— según vuestro estilo y presupuesto, un catering premium de 3 platos con entrante, plato principal y postre (servicio de camareros y puesta de mesas), cóctel de bienvenida de 1,5 h y barra libre de 3 h con bebidas nacionales y cócteles, DJ profesional con sonido e iluminación ambiental, alojamiento para 5 habitaciones en la misma finca (o en un alojamiento cercano) con tarifas especiales, diseño e impresión de invitaciones de boda personalizadas y la elección de un coche nupcial para el traslado de los novios. Los costes pueden variar según la ubicación de la finca y la disponibilidad; hablamos con un asesor para ajustar tu reserva al detalle.",
                image="https://res.cloudinary.com/dlcovtv8q/image/upload/v1748587414/23774c38-49ee-488a-8cda-91386bf623ca_slfgur.png",
                city="España",
                price=3400,
                discountPrice=32804,
                rating=4.9,
            ...
            Belleza(
                ...
                descripcion="Ideal para bodas de hasta 150 invitados, el Paquete Esmerald te ofrece gestión completa de ceremonia civil y religiosa (permisos y decoración), selección de finca exclusiva a tu medida, un catering premium de 4 platos con entrante, primer plato, principal y postre (servicio de camareros y puesta de mesas), cóctel de bienvenida de 1,5 h y barra libre de 3 h con bebidas nacionales y cócteles de autor, DJ profesional con sonido, iluminación y playlist personalizada, tarta de boda artesanal diseñada a tu gusto, maquillaje nupcial profesional para la novia y hasta cuatro acompañantes (con prueba incluida), fotógrafo profesional que capturará cada instante, alojamiento en finca para 5 habitaciones y estancia en hotel cercano desde la noche anterior para 3 habitaciones, invitaciones personalizadas de diseño e impresión y coche nupcial elegido por vosotros. Los precios son orientativos según finca y disponibilidad; consúltanos para ajustar tu reserva al detalle..",
                image="https://res.cloudinary.com/dlcovtv8q/image/upload/v1748609393/5a8db6bd-00ee-4f9c-888e-cf1a284dfbdf_naeh4p.png",
                city="España",
                price=42299,
                discountPrice=45810,
                rating=4.85,
            ...
            Belleza(
                ...
                descripcion="Ideal para bodas de hasta 250 invitados, el Paquete Diamond te ofrece, gestión integral de ceremonia civil y religiosa con permisos y decoración personalizada en ayuntamiento, exterior o iglesia; asesoramiento para la selección de una finca exclusiva —rústica o moderna— que refleje vuestro estilo; un catering premium de 4 platos (entrante · primer plato · principal · postre) servido por nuestro equipo de camareros con montaje de mesas; cóctel de bienvenida de 1,5 h y barra libre de 3 h con bebidas nacionales y cócteles de autor; DJ profesional con sonido, iluminación ambiental y playlist a la carta; tarta de boda artesanal diseñada a vuestro gusto; maquillaje nupcial profesional para la novia y hasta cuatro acompañantes; fotógrafo profesional que capturará cada instante; alojamiento: cinco habitaciones reservadas en finca o hotel cercano desde la noche anterior y ocho habitaciones la noche de la boda; invitaciones personalizadas con diseño, impresión y envío, y coche nupcial a elección de modelo. Precios orientativos según finca y disponibilidad; consúltanos para ajustar tu reserva al detalle",
                image="https://res.cloudinary.com/dlcovtv8q/image/upload/v1748609473/5bd65941-acd0-4dcc-b556-d9a67840a0dd_1_aoe9vm.png",
                city="España",
                price=70000,
                discountPrice=61425,
                rating=4.9,
