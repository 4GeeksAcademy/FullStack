...
YOUR_DOMAIN = "https://urban-waffle-qr474pr4q9929w5g-3000.app.github.dev"  # Cambia esta URL si es otro entorno
...
def create_checkout_session():
    try:
        ...
        session = stripe.checkout.Session.create(
            ...
            mode='payment',
            ui_mode='embedded',
            return_url=f"https://urban-waffle-qr474pr4q9929w5g-3000.app.github.dev/return?session_id={{CHECKOUT_SESSION_ID}}"
        )
...
def forgot_password():
    ...
    if user:
        ...
        frontend_url = os.getenv('FRONTEND_URL', 'https://urban-waffle-qr474pr4q9929w5g-3000.app.github.dev')
