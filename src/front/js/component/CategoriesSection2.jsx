...
const CategoriesSection2 = ({ categories, onNavigate }) => {
 ...
 const items = categories || [
    ...
    { id: "viajes",      name: "Tendencias 2025", icon: "📈", url: "/tendencias2025" },
    {
      ...
      name: "Contacto",
      icon: "📞",
      href: "https://wa.me/34641363127?text=Hola%20buen%20dia%20quiero%20solicitar%20informacion%20sobre%20los%20paquetes%20de%20bodas"
    }
  ];
    ...
    <section className="py-5 bg-white">
      <div className="container col-12 col-sm-10 col-md-10 col-lg-10 mx-auto px-3 px-sm-4">
        ...
        <div className="row g-3">
         {items.map(({ id, name, icon, url, href }) => (
